...
describe('Create Bill', function () {
    it('Criando um novo boleto com sucesso', function () {
        Sanctum::actingAs(
            User::query()->first(),
            ['*']
        );
        $response = $this->postJson('api/bill/store', $this->data);
    ...
    it('Não enviando dados nenhum para criar um novo boleto', function () {
        ...
        $response = $this->postJson('api/bill/store', []);
