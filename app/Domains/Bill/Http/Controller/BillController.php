...
class BillController extends Controller
{
    public function store(StoreBillRequest $request, StoreBillAction $storeBillAction)
    {
        ...
        DB::transaction(function () use ($data, $storeBillAction) {
    ...
    {
        $data = $request->validated();
        DB::transaction(function () use ($data, $bill, $updateBillAction) {
    ...
    {
        DB::transaction(function () use ($bill, $restoreBillAction) {
