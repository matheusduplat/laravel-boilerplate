...
return [
    ...
    'attributes' => [
        ...
        'phones' => 'telefones',
        'phones.*.type' => 'tipo de telefone',
        'phones.*.number' => 'número de telefone',
        'with_trashed' => 'com deletados',
        ...
        'address.street' => 'rua/avenida',
        'address.number' => 'número',
        'address.complement' => 'complemento',
        'file' => 'arquivo',
        'title_id' => 'id único do boleto',
        'title' => 'título do boleto',
        'description' => 'descrição do boleto',
        'due_date' => 'data de vencimento do boleto',
        'base_year' => 'ano da parcela',
        'base_month' => 'mês da parcela',
        'issue_date' => 'data de emissão do boleto',
