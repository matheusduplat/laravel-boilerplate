    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-user-store">Store a newly created resource in storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value não contém um endereço de email válido. Example: <code>qkunze@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve conter 6 dígitos. Example: <code>810798</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-user-store">Store a newly created resource in storage.</h2>
